#!/usr/bin/env bash
# LLM factory smoke (M0): print provider/model, construct client, optional --ping.
# This is NOT the coding agent — use ./scripts/agent.sh for that.
#
# Usage:
#   ./scripts/smoke.sh
#   ./scripts/smoke.sh --ping
set -euo pipefail
