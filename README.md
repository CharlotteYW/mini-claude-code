...
**Status:** Milestones **M0–M36 Done**. Tier 5 continues (**M37–M38** Planned) — see [docs/ROADMAP.md](docs/ROADMAP.md).
...
│   ├── ROADMAP.md
│   ├── notes/testing.md
│   └── milestones/              # M0–M36 Done; M37–M38 Planned stubs
...
| 5 | M27–M38 | Depth digs (M27–M36 Done; M37+ Planned) |
