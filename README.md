...
**Status:** Milestones **M0–M31 Done**. Tier 5 continues (**M32–M38** Planned) — see [docs/ROADMAP.md](docs/ROADMAP.md).
...
│   ├── ROADMAP.md
│   ├── notes/testing.md
│   └── milestones/              # M0–M31 Done; M32–M38 Planned stubs
...
| 5 | M27–M38 | Depth digs (M27–M31 Done; M32+ Planned: parallel tools, traces, handoff, …) |
