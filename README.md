...
**Status:** Milestones **M0–M34 Done**. Tier 5 continues (**M35–M38** Planned) — see [docs/ROADMAP.md](docs/ROADMAP.md).
...
│   ├── ROADMAP.md
│   ├── notes/testing.md
│   └── milestones/              # M0–M34 Done; M35–M38 Planned stubs
...
| 5 | M27–M38 | Depth digs (M27–M34 Done; M35+ Planned: handoff, …) |
