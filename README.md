...
**Status:** Milestones **M0–M30 Done**. Tier 5 continues (**M31–M38** Planned) — see [docs/ROADMAP.md](docs/ROADMAP.md).
...
│   ├── ROADMAP.md
│   ├── notes/testing.md
│   └── milestones/              # M0–M30 Done; M31–M38 Planned stubs
...
| 5 | M27–M38 | Depth digs (M27–M30 Done; M31+ Planned: time-travel, traces, handoff, …) |
