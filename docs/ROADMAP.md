...
| M8 | [Project + long-term memory](milestones/M8-project-long-term-memory.md) | **Done.** `AGENT.md` inject + Neo4j `Fact` tools; vectors docs-only (A); M20/M21 parked for ingestion/ES. |
