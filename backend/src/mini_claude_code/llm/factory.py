...
def create_chat_model(
    ...
    *,
    ...
    if provider == "anthropic":
        ...
        # Prompt caching (M37): breakpoints live in agent/prompt_cache.py —
        # Anthropic cache_control on stable system prefix + invoke kwarg.
        # Not wired into the factory itself so ollama/openai stay unchanged.
